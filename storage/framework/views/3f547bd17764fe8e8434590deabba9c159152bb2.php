...
<?php $__env->startSection('styles'); ?>
    <link rel="stylesheet"
        href="<?php echo e(url('storage/app/public/admin-assets/assets/css/bootstrap/bootstrap-select.v1.14.0-beta2.min.css')); ?>">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="cat_id"
                                                        class="col-form-label"><?php echo e(trans('labels.category')); ?> <span class="text-danger">*</span> </label>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control selectpicker" name="addons_id[]" multiple data-live-search="true">
                                                ...
                                                <?php $__currentLoopData = $getaddons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $addons): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($addons->id); ?>"
                                                        <?php echo e(!empty(old('addons_id')) && in_array($addons->id, old('addons_id')) ? 'selected' : ''); ?>>
                                                        <?php echo e($addons->name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="item_type"
                                                class="col-form-label"><?php echo e(trans('labels.item_type')); ?> <span class="text-danger">*</span> </label>
                                            <div class="col-md-12">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="row dn <?php if($errors->has('variants_name.*') || $errors->has('variants_price.*')): ?> dn <?php endif; ?> <?php if(old('variants') == 2): ?> d-flex <?php endif; ?>"
                                    ...
                                    <div class="col-sm-12 col-md-12">
                                        <div class="form-group">
                                            <label for="price"
                                                class="col-form-label"><?php echo e(trans('labels.price')); ?> <span class="text-danger">*</span> </label>
                                            <input type="text" class="form-control" name="price" id="price"
                                                value="<?php echo e(old('price')); ?>" placeholder="<?php echo e(trans('labels.price')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="row panel-body dn <?php if($errors->has('variation.*') || $errors->has('product_price.*') || old('has_variation') == 1): ?> d-flex <?php endif; ?>"
                                    id="variations">
                                    <div class="col-md-12">
                                        <div class="form-group">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-sm-5">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control product_price"  name="product_price[]" placeholder="<?php echo e(trans('labels.product_price')); ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-4 d-none">
                                        <div class="form-group">
                                            <label class="col-form-label"><?php echo e(trans('labels.sale_price')); ?><span class="text-danger">*</span></label>
                                            <input type="text" class="form-control sale_price"  name="sale_price[]" placeholder="<?php echo e(trans('labels.sale_price')); ?>"
                                                value="0">
                                        </div>
                                    </div>
                                    <div class="col-sm-1 d-flex align-items-end">
                                        <div class="form-group">
                                            <button class="btn btn-info" type="button" onclick="variation_fields('<?php echo e(trans('labels.variation')); ?>','<?php echo e(trans('labels.product_price')); ?>','<?php echo e(trans('labels.sale_price')); ?>');"> <i class="fa-sharp fa-solid fa-plus"></i> </button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="col-form-label"><?php echo e(trans('labels.image')); ?> (512x512) <span class="text-danger">*</span> </label>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="col-form-label"><?php echo e(trans('labels.preparation_time')); ?> <span class="text-danger">*</span></label>
...
<?php $__env->startSection('script'); ?>
    <script src="<?php echo e(url('storage/app/public/admin-assets/assets/js/bootstrap/bootstrap-select.v1.14.0-beta2.min.js')); ?>">
    </script>
    <script src="<?php echo e(url('resources/views/admin/item/additem.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.theme.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\resturant\resources\views/admin/item/additem.blade.php ENDPATH**/ ?>