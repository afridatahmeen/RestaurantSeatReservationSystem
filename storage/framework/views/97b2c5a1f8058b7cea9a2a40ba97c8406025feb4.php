...
unset($__errorArgs, $__bag); ?>
    ...
    <script src="<?php echo e(url('/storage/app/public/web-assets/js/intl-tel-input/17.0.8.intlTelInput.min.js')); ?>"></script>
    <link rel="stylesheet" href="<?php echo e(url('/storage/app/public/web-assets/js/intl-tel-input/17.0.8.intlTelInput.min.css')); ?>">
    <script src="<?php echo e(url('/storage/app/public/web-assets/js/intl-tel-input/17.0.8.utils.js')); ?>"></script>
    <script>
        var input = $('#mobile');
...
</html><?php /**PATH D:\Application\laragon\www\restaurant_management_system\resources\views/web/auth/login.blade.php ENDPATH**/ ?>