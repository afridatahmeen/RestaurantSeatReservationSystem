                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="row align-items-center justify-content-between gx-0">
                                                    <div class="col-auto">
                                                        <span
                                                            class="green_color fs-8"><?php echo e($itemdata['category_info']->category_name); ?></span>
                                                        <?php
                                                        ...
                                                        <?php if(Auth::user() && Auth::user()->type == 2): ?>
                                                            <?php if($itemdata->is_cart == 1): ?>
                                                                <div class="item-quantity">
                                                                    ...
                                                                    <input
                                                                        class="green_color fw-500 item-total-qty-<?php echo e($itemdata->slug); ?>"
                                                                        type="text"
...
<?php echo $__env->make('web.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\resturant\resources\views/web/favoritelist.blade.php ENDPATH**/ ?>