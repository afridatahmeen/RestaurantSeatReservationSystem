    ...
    <tbody>
        ...
        <tr id="dataid<?php echo e($orderdata->id); ?>">
            ...
            <td>
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <?php if($orderdata->order_from == 'pos'): ?>
                        ...
                        <a class="dropdown-item w-auto" 
                              title="<?php echo e(trans('labels.reject')); ?>"
                    ...
                    <?php else: ?>
                        <a class="dropdown-item w-auto <?php if($orderdata->status == '1'): ?> fw-600 <?php endif; ?>"
                              title="<?php echo e(trans('labels.accept')); ?>"
                        ...
                        <a class="dropdown-item w-auto <?php if($orderdata->status == '2'): ?> fw-600 <?php endif; ?>"
                              title="<?php echo e(trans('labels.ready')); ?>"
                        ...
                        <?php if($orderdata->order_type == '2'): ?>
                            <a class="dropdown-item w-auto <?php if($orderdata->status == '3'): ?> fw-600 <?php endif; ?>"
                                  title="<?php echo e(trans('labels.ready_pickup')); ?>"
                        ...
                        <?php else: ?>
                            <a class="dropdown-item w-auto <?php if($orderdata->status == '3'): ?> fw-600 <?php endif; ?> open-AddBookDialog"
                                data-bs-toggle="modal" data-id="<?php echo e($orderdata->id); ?>"
                                data-number="<?php echo e($orderdata->order_number); ?>"
                                data-bs-target="#myModal"><?php echo e(trans('labels.assign_to_driver')); ?></a>
                        <?php endif; ?>
                ...
                <a class="btn btn-sm btn-light" title="<?php echo e(trans('labels.view')); ?>" href="<?php echo e(URL::to('admin/invoice/' . $orderdata->id)); ?>"><i class="fa fa-list"></i></a>
            </td>
        </tr>
        <?php
        $i++;
...
<?php /**PATH D:\Application\laragon\www\restaurant_management_system\resources\views/admin/orders/orderstable.blade.php ENDPATH**/ ?>