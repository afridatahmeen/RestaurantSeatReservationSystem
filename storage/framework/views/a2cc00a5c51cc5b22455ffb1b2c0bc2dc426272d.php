                    ...
                    <li class="nav-item dropdown list-unstyled">
                        ...
                        <ul class="dropdown-menu dropdown-menu-custom" aria-labelledby="menudropdown" id="style-3">
                            <?php $__currentLoopData = Helper::get_categories(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li><a class="dropdown-item text-dark <?php if(isset($_GET['category']) && $_GET['category'] == $category->slug): ?> active <?php endif; ?>"
                                        href="<?php echo e(URL::to('/menu?category=' . $category->slug)); ?>"><?php echo e($category->category_name); ?></a>
                                </li>
...
<?php /**PATH D:\Application\laragon\www\restaurant_management_system\resources\views/web/layout/header.blade.php ENDPATH**/ ?>