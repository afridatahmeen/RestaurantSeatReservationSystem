...
<head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="<?php echo e(url('storage/app/public/admin-assets/assets/css/fontawesome/all.min.css')); ?>">
    <!-- FontAwesome CSS -->
    ...
    <link rel="stylesheet" href="<?php echo e(url('storage/app/public/admin-assets/assets/css/responsive.css')); ?>">
    <!-- Responsive CSS -->
    <link rel="stylesheet"
        href="<?php echo e(url('storage/app/public/admin-assets/assets/css/datatables/dataTables.bootstrap5.min.css')); ?>">
    <!-- dataTables css -->
    <link rel="stylesheet"
        href="<?php echo e(url('storage/app/public/admin-assets/assets/css/datatables/dataTables.bootstrap5.min.css')); ?>">
    <!-- dataTables css -->
    <link rel="stylesheet"
        href="<?php echo e(url('storage/app/public/admin-assets/assets/css/datatables/buttons.dataTables.min.css')); ?>">
    <!-- dataTables css -->
...
unset($__errorArgs, $__bag); ?>
            ...
            <footer class="py-3 text-center bg-white fixed-bottom border-top">
                <?php echo e(trans('labels.designed_developed_by')); ?> <a
...
<?php /**PATH D:\Application\laragon\www\restaurant_management_system\resources\views/admin/theme/default.blade.php ENDPATH**/ ?>