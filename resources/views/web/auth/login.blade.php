...
<body>
    ...
    <script src="{{ url('/storage/app/public/web-assets/js/intl-tel-input/17.0.8.intlTelInput.min.js') }}"></script>
    <link rel="stylesheet" href="{{ url('/storage/app/public/web-assets/js/intl-tel-input/17.0.8.intlTelInput.min.css') }}">
    <script src="{{ url('/storage/app/public/web-assets/js/intl-tel-input/17.0.8.utils.js') }}"></script>
    <script>
        var input = $('#mobile');
