...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 19, 2022 at 09:35 AM
...
CREATE TABLE `about` (
  ...
  `app_bottom_image` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `mobile_app_image` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `mobile_app_title` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `mobile_app_description` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `image` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'about-image',
  ...
  `footer_bg_image` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `booknow_bg_image` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `reviews_bg_image` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `mobile_app_bg_image` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `banner` (
  ...
  `type` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '1=category,2=item',
...
CREATE TABLE `item` (
  ...
  `price` varchar(11) COLLATE utf8mb4_unicode_ci DEFAULT '0',
  `addons_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `item_description` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `preparation_time` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0' COMMENT 'In minutes',
  `tax` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `order` (
  ...
  `order_type` varchar(11) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1' COMMENT '1 = Delivery , 2 = Pickup',
  `address_type` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '1- Home, 2-Office, 3-Other',
  ...
  `discount_amount` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT '0.00',
  `delivery_charge` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT '0.00',
  `tax_amount` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT '0.00',
  `grand_total` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `transaction_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `transaction_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '1 = cod, 2=wallet,3=razorpay,4=stripe/5=flutterwave,6=paystack',
  `status` varchar(11) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '1=Order-placed(both)\r\n2=accepted-by-admin(both)\r\n3=order-ready(both)\r\n4=order-on-the-way(delivery) && waiting-for-pickup(pickup)\r\n5=order-completed(both)\r\n6=cancelled-by-admin(both)\r\n7=cancelled-by-user(both)',
...
CREATE TABLE `users` (
  ...
  `identity_image` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `identity_type` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
