...
unset($__errorArgs, $__bag); ?>" name="domain" required autocomplete="current-domain" value="<?php echo e($text); ?>" placeholder="domain" readonly="">
                                    ...
                                    <button class="btn btn-primary w-100 my-3" type="submit"><?php echo e(trans('labels.submit')); ?></button>
                                </form>
...
</html><?php /**PATH D:\laragon\www\resturant\resources\views//auth.blade.php ENDPATH**/ ?>