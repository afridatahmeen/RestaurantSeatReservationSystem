...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(url('storage/app/public/admin-assets/assets/css/bootstrap/bootstrap.min.css')); ?>"><!-- Bootstrap CSS -->
    <link rel="stylesheet" href="<?php echo e(url('storage/app/public/admin-assets/assets/css/fontawesome/all.min.css')); ?>"><!-- FontAwesome CSS -->
    <link rel="stylesheet" href="<?php echo e(url('storage/app/public/admin-assets/assets/css/toastr/toastr.min.css')); ?>"><!-- FontAwesome CSS -->
    <link rel="stylesheet" href="<?php echo e(url('storage/app/public/admin-assets/assets/css/style.css')); ?>"><!-- Custom CSS -->
    <link rel="stylesheet" href="<?php echo e(url('storage/app/public/admin-assets/assets/css/responsive.css')); ?>"><!-- Responsive CSS -->
</head>
<body>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <button class="btn btn-primary w-100 my-3" type="submit"><?php echo e(trans('labels.signin')); ?></button>
                                </form>
                                ...
                                <div class="mb-3 text-center">
                                    <a href="<?php echo e(URL::to('admin/forgot-password')); ?>" class="text-muted fs-8 fw-500">
                                        <i class="fa-solid fa-lock-keyhole mx-2 fs-7"></i><?php echo e(trans('labels.forgot_password_q')); ?>
    ...
    <script src="<?php echo e(url('storage/app/public/admin-assets/assets/js/common.js')); ?>"></script><!-- Common JS -->
    <script>
        toastr.options = {
            "closeButton": true,
            "progressBar": true
...
</html><?php /**PATH D:\Application\laragon\www\restaurant_management_system\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>