                            ...
                            <div class="card border-0 box-shadow h-100">
                                <div class="card-body">
                                    <div class="dashboard-card">
                                        ...
                                        <span class="text-end">
                                            <p class="text-muted fw-medium mb-1"><?php echo e(trans('labels.orders')); ?></p>
...
<?php echo $__env->make('admin.theme.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Application\laragon\www\restaurant_management_system\resources\views/admin/dashboard/home.blade.php ENDPATH**/ ?>