...
<head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="{{ url('/storage/app/public/web-assets/css/owl_carousel/owl.carousel.min.css') }}">
    <!-- owl-carousel css -->
    <link rel="stylesheet"
        href="{{ url('/storage/app/public/web-assets/css/owl_carousel/owl.theme.default.min.css') }}">
    <!-- owl-carousel css -->
...
<body>
    ...
    <script src="{{ url('/storage/app/public/web-assets/js/owl_carousel/owl.carousel.js') }}"></script><!-- owl carousel js -->
    <script src="{{ url('/storage/app/public/web-assets/js/bootstrap/bootstrap.bundle.min.js') }}"></script><!-- Bootstrap CSS -->
    ...
    <script src="{{ url('/storage/app/public/web-assets/js/common.js') }}"></script><!-- web-common-js -->
    @yield('scripts')
</body>
</html>
