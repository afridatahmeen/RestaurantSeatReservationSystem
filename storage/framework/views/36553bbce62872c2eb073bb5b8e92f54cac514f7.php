                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="email" value="<?php echo e(@$getsettings->email == '' ? old('email') : @$getsettings->email); ?>" placeholder="<?php echo e(trans('labels.email')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="mobile" value="<?php echo e(@$getsettings->mobile == '' ? old('mobile') : @$getsettings->mobile); ?>" placeholder="<?php echo e(trans('labels.mobile')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="col-form-label" for=""><?php echo e(trans('labels.address')); ?>

                                                <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" name="address" id="address" value="<?php echo e(@$getsettings->address == '' ? old('address') : @$getsettings->address); ?>">
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group">
                                            <label class="col-form-label" for=""><?php echo e(trans('labels.latitude')); ?>

                                                <span class="text-danger">*</span></label>
                                            <input type="text" placeholder="<?php echo e(trans('labels.latitude')); ?>" value="<?php echo e(@$getsettings->lat == '' ? old('lat') : @$getsettings->lat); ?>"
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group">
                                            <label class="col-form-label" for=""><?php echo e(trans('labels.longitude')); ?>

                                                <span class="text-danger">*</span></label>
                                            <input type="text" placeholder="<?php echo e(trans('labels.longitude')); ?>" value="<?php echo e(@$getsettings->lang == '' ? old('lang') : @$getsettings->lang); ?>"
                        ...
                        <div class="card border-0">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="col-form-label" for=""><?php echo e(trans('labels.map_key')); ?>

                                                <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" name="map" id="map" value="<?php echo e(@$getsettings->map == '' ? old('map') : @$getsettings->map); ?>" placeholder="<?php echo e(trans('labels.map_key')); ?>">
                                            <?php $__errorArgs = ['map'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="col-form-label" for=""><?php echo e(trans('labels.firebase_key')); ?> <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control" name="firebase" id="firebase" value="<?php echo e(@$getsettings->firebase == '' ? old('firebase') : @$getsettings->firebase); ?>" placeholder="<?php echo e(trans('labels.firebase_key')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group">
                                            <label class="col-form-label" for=""><?php echo e(trans('labels.og_image')); ?> (1200x650) </label>
                        ...
                        <div class="card border-0">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="col-form-label" for=""><?php echo e(trans('labels.currency')); ?>

                                            </label>
                                            <input type="text" placeholder="<?php echo e(trans('labels.currency')); ?>" value="<?php echo e(@$getsettings->currency == '' ? old('currency') : @$getsettings->currency); ?>"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="col-form-label" for=""><?php echo e(trans('labels.currency_position')); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="col-form-label" for=""><?php echo e(trans('labels.referral_amount')); ?> <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" placeholder="<?php echo e(trans('labels.referral_amount')); ?>" value="<?php echo e(@$getsettings->referral_amount == '' ? old('referral_amount') : @$getsettings->referral_amount); ?>"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="col-form-label" for=""><?php echo e(trans('labels.max_order_qty')); ?> <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" placeholder="<?php echo e(trans('labels.max_order_qty')); ?>" value="<?php echo e(@$getsettings->max_order_qty == '' ? old('max_order_qty') : @$getsettings->max_order_qty); ?>"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="col-form-label" for=""><?php echo e(trans('labels.min_amount')); ?>

                                                <span class="text-danger">*</span></label>
                                            <input type="text" placeholder="<?php echo e(trans('labels.min_amount')); ?>" value="<?php echo e(@$getsettings->min_order_amount == '' ? old('min_order_amount') : @$getsettings->min_order_amount); ?>"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="col-form-label" for=""><?php echo e(trans('labels.max_amount')); ?>

                                                <span class="text-danger">*</span></label>
                                            <input type="text" placeholder="<?php echo e(trans('labels.max_amount')); ?>" value="<?php echo e(@$getsettings->max_order_amount == '' ? old('max_order_amount') : @$getsettings->max_order_amount); ?>"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="col-form-label" for=""><?php echo e(trans('labels.delivery_charge_per_km')); ?>

                                                <span class="text-danger">*</span></label>
                                            <input type="text" placeholder="<?php echo e(trans('labels.delivery_charge_per_km')); ?>" value="<?php echo e(@$getsettings->delivery_charge == '' ? old('delivery_charge') : @$getsettings->delivery_charge); ?>"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="col-form-label" for=""><?php echo e(trans('labels.maintenance_mode')); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="col-form-label" for=""><?php echo e(trans('labels.mobile_app_image')); ?> (650X750) </label>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group">
                                            <label class="col-form-label" for=""><?php echo e(trans('labels.bg_image')); ?> (1920X300) </label>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="col-form-label" for=""><?php echo e(trans('labels.logo')); ?> (250X250) </label>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="col-form-label" for=""><?php echo e(trans('labels.Favicon')); ?> (16X16) </label>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="col-form-label" for=""><?php echo e(trans('labels.auth_bg_image')); ?> (1920X1280) </label>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="col-form-label" for=""><?php echo e(trans('labels.breadcrumb_bg_image')); ?> (1920X300) </label>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="col-form-label" for=""><?php echo e(trans('labels.booknow_bg_image')); ?> (1920X550) </label>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="col-form-label" for=""><?php echo e(trans('labels.reviews_bg_image')); ?> (1920X550) </label>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="col-form-label" for=""><?php echo e(trans('labels.footer_logo')); ?> (250X250) </label>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group">
                                            <label class="col-form-label" for=""><?php echo e(trans('labels.footer_bg_image')); ?> (1920X650) </label>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="col-form-label" for=""><?php echo e(trans('labels.footer_features')); ?> <span class="" data-bs-toggle="tooltip" data-bs-placement="top" title="Ex. <i class='fa-solid fa-truck-fast'></i> Visit https://fontawesome.com/ for more info"> <i class="fa-solid fa-circle-info"></i> </span>  </label>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3 form-group">
                                                        <input type="text" class="form-control"
                                                            ...
                                                            placeholder="<?php echo e(trans('labels.icon')); ?>" value="<?php echo e($features->icon); ?>" required>
                                                    </div>
                                                    <div class="col-md-3 form-group">
                                                        <input type="text" class="form-control"
                                                            name="edi_feature_title[<?php echo e($features->id); ?>]"
                                                            placeholder="<?php echo e(trans('labels.title')); ?>" value="<?php echo e($features->title); ?>" required>
                                                    </div>
...
<?php echo $__env->make('admin.theme.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Application\laragon\www\restaurant_management_system\resources\views/admin/cms/settings.blade.php ENDPATH**/ ?>