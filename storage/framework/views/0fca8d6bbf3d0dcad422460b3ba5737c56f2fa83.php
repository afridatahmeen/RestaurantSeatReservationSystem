        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item <?php echo e($key == 0 ? 'active' : ''); ?>">
                ...
                <div class="carousel-caption d-flex h-100 align-items-center justify-content-center flex-column">
                    ...
                    <a href="<?php echo e(URL::to('/menu/?category=' . $sliderdata['category_info']->slug)); ?>" class="btn btn-primary fw-bold"><?php echo e(trans('labels.explore')); ?> <i class="fa-solid fa-circle-arrow-right"></i> </a>
                    <?php endif; ?>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="row align-items-center justify-content-between">
                    <div class="col-auto">
                        <h1 class="text-capitalize fw-bold"><?php echo e(trans('labels.categories')); ?></h1>
                    </div>
                    <div class="col-auto text-end align-center">
                        <a href="<?php echo e(route('categories')); ?>" class="btn btn-sm btn-outline-primary"><?php echo e(trans('labels.view_all')); ?></a>
                    </div>
                </div>
...
<?php echo $__env->make('web.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Application\laragon\www\restaurant_management_system\resources\views/web/index.blade.php ENDPATH**/ ?>